...
// This package depends on github.com/giantswarm/mcp-oauth v0.2.46 for OAuth 2.1 implementation.
...
// Recent updates: v0.2.46 adds silent authentication support via OIDC prompt=none parameter.
package oauth
